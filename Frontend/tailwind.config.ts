...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      // Tailwind's default text-* scale, uniformly bumped 15% — letters across
      // the app were reading too small (30% was tried first and felt too big).
      // Only font sizes/line-heights move; spacing, icons, and component
