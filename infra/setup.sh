...
echo ""
echo "  Also set these GitHub repo VARIABLES (not secrets — see README/CLAUDE.md):"
echo "  ENTRA_TENANT_ID / ENTRA_CLIENT_ID | Entra ID App Registration for Sign in with Microsoft"
echo ""
echo "  ADMIN_EMAIL (in infra/main.bicepparam) must match the Entra ID account"
echo "  that should have admin access — there is no admin password to set."
echo ""
echo "=========================================================================="
echo "  NEXT STEPS"
echo "=========================================================================="
