#!/usr/bin/env bash
# =============================================================================
# <PROJECT_NAME> — One-time Azure bootstrap script (reusable template)
# =============================================================================
...
LOCATION="eastus2"
ACR_NAME="myappacr"                             # Must match acrName in main.bicep
APP_NAME="myapp-github-actions"                 # Entra ID App Registration name
GITHUB_ORG="your-github-org"                    # GitHub user or org (must match the repo owner exactly)
GITHUB_REPO="your-repo"                         # GitHub repository name (must match exactly, case-sensitive for OIDC)
...
if [[ -n "$EXISTING_CRED" ]]; then
  ...
  az ad app federated-credential create \
    ...
    --parameters "{
      ...
      \"description\": \"GitHub Actions OIDC deployments on branch ${GITHUB_BRANCH}\",
...
echo "  ADMIN_PASSWORD         | <initial admin login password — min 8 chars; forced to change on first login>"
echo ""
echo "=========================================================================="
echo "  NEXT STEPS"
echo "=========================================================================="
...
echo "     or push a commit to ${GITHUB_BRANCH}."
echo ""
...
echo ""
echo "  4. (Optional) Add a custom domain to the Container Apps."
echo "=========================================================================="
